    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=60, help_text="Typical duration in minutes"
                    ),
                ),
                (
                    "sequence_order",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration_minutes",
                    models.PositiveIntegerField(
                        default=60, help_text="Planned duration in minutes"
                    ),
                ),
                (
                    "location",
                ...
                (
                    "interviewer_notes",
                    models.TextField(
                        blank=True, help_text="Private notes from the interviewer"
                    ),
                ),
                (
                    "preparation_notes",
                    models.TextField(
                        blank=True, help_text="Notes for interview preparation"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "individual_feedback",
                    models.TextField(
                        blank=True, help_text="This participant's individual feedback"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=5, help_text="Estimated time to answer this question"
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
                (
                ...
                (
                    "follow_up_questions",
                    models.TextField(
                        blank=True, help_text="Suggested follow-up questions"
                    ),
                ),
                (
                    "ideal_answer_points",
                    models.TextField(
                        blank=True, help_text="Key points to look for in ideal answers"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "criteria_name",
                    models.CharField(
                        help_text="Name of the criteria being evaluated", max_length=100
                    ),
                ),
                (
                    "score",
                ...
                (
                    "comments",
                    models.TextField(
                        blank=True, help_text="Comments specific to this criteria"
                    ),
                ),
                (
                    "weight",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="criteria_evaluations",
                        to="interview.interviewparticipant",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "candidate_answer",
                    models.TextField(
                        blank=True, help_text="Candidate's response to the question"
                    ),
                ),
                (
                    "interviewer_notes",
                    models.TextField(
                        blank=True, help_text="Interviewer's notes about the response"
                    ),
                ),
                (
                    "response_score",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the feedback template", max_length=100
                    ),
                ),
                (
                    "description",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="interviews_candida_1bf2e0_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="interview",
            index=models.Index(
                fields=["mpr", "-scheduled_date"], name="interviews_mpr_id_9e0b6f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="interview",
            index=models.Index(
                fields=["status", "scheduled_date"], name="interviews_status_644dea_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="interview",
            index=models.Index(
                fields=["interview_round", "-scheduled_date"],
                name="interviews_intervi_8ef3c6_idx",
            ),
        ),
    ]
